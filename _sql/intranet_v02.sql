...
INSERT INTO `action` (`id_action`, `name`, `description`, `uri`, `icon`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`, `is_delete`) VALUES
(1, '1', '2', '2', '3', 'activo', NULL, '2021-05-05 20:08:36', NULL, '2021-05-05 20:08:36', 'vigente'),
(2, '3', '3', '3', '3', 'activo', NULL, '2021-05-05 20:08:36', NULL, '2021-05-05 20:08:36', 'vigente');
...
CREATE TABLE `company` (
  ...
  `short_key` varchar(20) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `_default` enum('y','n') COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'y',
  `status` enum('activo','inactivo') COLLATE utf8_spanish2_ci DEFAULT 'activo',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `user_created` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `company` (`id_company`, `name`, `initials`, `description`, `company_logo`, `code`, `short_key`, `_default`, `status`, `created_at`, `user_created`, `updated_at`, `user_updated`, `is_delete`) VALUES
(1, 'ENDETEC', 'ET', '<p>\n	123</p>\n', '06bfe-_foto1.jpg', 'ET-EMP1111', NULL, 'y', 'activo', '2021-04-27 19:14:56', NULL, '2021-04-28 02:40:12', '#DEINS', 'vigente'),
(2, 'Despliegue - Sistema Compras ET', 'ET', '<p>\n	wewwwwwww</p>\n', '58da2-d4c17d48d9e0a5ac9986887163f435ec.jpg', 'ET-EMP222', 'CMP-DATA2', 'n', 'activo', '2021-04-27 18:29:04', NULL, '2021-05-01 00:13:14', '#DEINS', 'vigente'),
(3, 'Despliegue - Sistema Compras ET', 'ET', '<p>\r\n	wewwwwwww</p>\r\n', '58da2-d4c17d48d9e0a5ac9986887163f435ec.jpg', 'ET-EMP222', 'CMP-DATA2', 'n', 'activo', '2021-04-27 18:29:04', NULL, '2021-05-01 00:13:14', '#DEINS', 'vigente'),
(4, 'Despliegue - Sistema Compras ET', 'ET', '<p>\r\n	wewwwwwww</p>\r\n', '58da2-d4c17d48d9e0a5ac9986887163f435ec.jpg', 'ET-EMP222', 'CMP-DATA2', 'n', 'activo', '2021-04-27 18:29:04', NULL, '2021-05-01 00:13:14', '#DEINS', 'vigente'),
(5, 'Despliegue - Sistema Compras ET', 'ET', '<p>\r\n	wewwwwwww</p>\r\n', '58da2-d4c17d48d9e0a5ac9986887163f435ec.jpg', 'ET-EMP222', 'CMP-DATA2', 'n', 'activo', '2021-04-27 18:29:04', NULL, '2021-05-01 00:13:14', '#DEINS', 'vigente'),
(6, 'Despliegue - Sistema Compras ET', 'ET', '<p>\r\n	wewwwwwww</p>\r\n', '58da2-d4c17d48d9e0a5ac9986887163f435ec.jpg', 'ET-EMP222', 'CMP-DATA2', 'n', 'activo', '2021-04-27 18:29:04', NULL, '2021-05-01 00:13:14', '#DEINS', 'vigente'),
(7, 'Despliegue - Sistema Compras ET', 'ET', '<p>\r\n	wewwwwwww</p>\r\n', '58da2-d4c17d48d9e0a5ac9986887163f435ec.jpg', 'ET-EMP222', 'CMP-DATA2', 'n', 'activo', '2021-04-27 18:29:04', NULL, '2021-05-01 00:13:14', '#DEINS', 'vigente'),
(8, 'ENDETEC', 'ET', '<p>\r\n	123</p>\r\n', '06bfe-_foto1.jpg', 'ET-EMP1111', NULL, 'n', 'activo', '2021-04-27 19:14:56', NULL, '2021-04-28 02:40:12', '#DEINS', 'vigente'),
(9, 'ENDETEC', 'ET', '<p>\r\n	123</p>\r\n', '06bfe-_foto1.jpg', 'ET-EMP1111', NULL, 'n', 'activo', '2021-04-27 19:14:56', NULL, '2021-04-28 02:40:12', '#DEINS', 'vigente'),
(10, 'ENDETEC', 'ET', '<p>\r\n	123</p>\r\n', '06bfe-_foto1.jpg', 'ET-EMP1111', NULL, 'n', 'activo', '2021-04-27 19:14:56', NULL, '2021-04-28 02:40:12', '#DEINS', 'vigente'),
(11, 'ENDETEC', 'ET', '<p>\r\n	123</p>\r\n', '06bfe-_foto1.jpg', 'ET-EMP1111', NULL, 'n', 'activo', '2021-04-27 19:14:56', NULL, '2021-04-28 02:40:12', '#DEINS', 'vigente'),
(12, 'ENDETEC', 'ET', '<p>\r\n	123</p>\r\n', '06bfe-_foto1.jpg', 'ET-EMP1111', NULL, 'n', 'activo', '2021-04-27 19:14:56', NULL, '2021-04-28 02:40:12', '#DEINS', 'vigente');
...
CREATE TABLE `event` (
  ...
  `color` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `objetive_group` int(11) DEFAULT NULL,
  `notification_mail` enum('activo','inactivo') COLLATE utf8_spanish2_ci DEFAULT 'activo',
  `uri` varchar(500) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `short_key` varchar(20) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `status` enum('activo','inactivo') COLLATE utf8_spanish2_ci DEFAULT 'activo',
  `user_created` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
(1, '12', '<p>\n	1221</p>\n', 'activo', '2021-04-29 03:24:12', '2021-04-30 00:20:51', '#DEINS', '#DEINS', 'vigente', '11', '2121', '212121'),
(2, 'Revision sistema Seguro Medico Delegado - DELAPAZ', '<p>\n	ewewqewq</p>\n', 'activo', '2021-04-29 23:49:17', '2021-04-29 17:49:24', '#DEINS', NULL, 'vigente', 'ewe', 'ewew', 'ewqeq'),
(3, 'dsds', '<p>\n	dsadsa</p>\n', 'activo', '2021-04-29 23:51:53', '2021-04-29 17:52:00', '#DEINS', NULL, 'vigente', 'dsdasa', 'dasdsa', 'dadsa');
...
INSERT INTO `people` (`id_people`, `name`, `pat_surename`, `mat_surename`, `ci`, `birthday`, `phone`, `mobile`, `personal_email`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`, `is_delete`) VALUES
(1, 'Denis', 'Rodriguez', 'Mendoza', '123444', '2021-05-05', '111111', '111111', '21212121', 'activo', 'denis.rodriguez', '2021-05-05 20:06:50', NULL, '2021-05-05 20:06:50', 'vigente');
...
CREATE TABLE `rol` (
  ...
  `name` varchar(250) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `description` text COLLATE utf8_spanish2_ci DEFAULT NULL,
  `visibility` enum('public','private') COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'private',
  `status` enum('activo','inactivo') COLLATE utf8_spanish2_ci DEFAULT 'activo',
  `user_created` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `user_updated` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
INSERT INTO `rol` (`id_rol`, `name`, `description`, `visibility`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`, `is_delete`) VALUES
(1, 'Admin', 'nada', 'private', 'activo', NULL, '2021-05-05 20:08:01', NULL, '2021-05-05 20:08:01', 'vigente'),
(2, 'Rol2', 'dsdsa', 'private', 'activo', 'denis.rodriguez', '2021-05-07 14:27:54', NULL, '2021-05-07 14:27:54', 'vigente');
...
--
-- Volcado de datos para la tabla `rol_action`
--

INSERT INTO `rol_action` (`id`, `id_rol`, `id_action`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 1);
...
(3, 2, 'comunidad', 'Hola bola', 'ET-EMP', '80794-2393352.png', NULL, 'CMP-DATA', 'activo', NULL, '2021-04-28 13:34:24', '#DEINS', '2021-05-05 21:17:48', 'vigente');
...
CREATE TABLE `user` (
  ...
  `ldap` enum('activo','inactivo') COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'activo',
  `status` enum('activo','inactivo') COLLATE utf8_spanish2_ci DEFAULT 'activo',
  `user_created` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `user_updated` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
INSERT INTO `user` (`id_user`, `id_site`, `id_people`, `username`, `password`, `photo`, `email`, `location`, `ip_phone`, `work_position`, `manager`, `notifications_active`, `ldap`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`, `is_delete`) VALUES
(1, 3, 1, 'denis.rodriguez', 'denis', NULL, 'asdsadsa', 'dsadsa', 'dsadsa', 'dads', 'dadsdas', 1, 'activo', 'activo', 'denis.rodriguez', '2021-05-05 20:07:48', NULL, '2021-05-05 20:07:48', 'vigente');
